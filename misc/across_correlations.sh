...
# for each model family combination on a separate node

# Iterate over all combinations of parameters.

dir_path=$DATA/tmp_models

# Use ls and grep to list directories NOT containing "lower" and store them in an array
directories=($(ls -d "$dir_path"/* | grep -v "lower"))
